...
```{r}
get_exp_growth_with_error = function(max_t, b_0, b_1, b_2, e_0_extremeness, e_1_extremeness, e_2_extremeness) {
    # y[t] is about (b_0 + e_0) + (b_1 + e_1)*exp((b_2 + e_2)*t)
    # where e_0, e_1 and e_2 are errors.
    # e_0_extremeness, e_1_extremeness & e_2_extremeness should be in [0, 1]
